  ...
  return (
    <div className='py-5 px-5 md:px-12 lg:px-28'>
      ...
      <div className='text-center my-8'>
        ...
        <p className='mt-10 max-w-[740px] m-auto text-xs sm:text-base'>Welcome to Blogger, your go-to platform for insightful articles and the latest trends. Discover a variety of blogs on technology, lifestyle, startups, and more. Join us in exploring ideas, sharing knowledge, and staying informed!</p>
